...
public class SearchProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public SearchProductAdapter(Context context, ArrayList<HomeShopeProductModel> modelList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
           ...
           // genericViewHolder.txtOffer.setText("Rs.534,33");

          //  genericViewHolder.txtOffer.setPaintFlags(genericViewHolder.txtOffer.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
         ...
         //  this.txtOffer=itemView.findViewById(R.id.txtOffer);
