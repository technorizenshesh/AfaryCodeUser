...
public class ReviewAdapter extends
    ...
    private ArrayList<ShoppingProductModal> all_category_subcategory;
    private final Context activity;
    private ShoppingProductDetail fragment;

    public ReviewAdapter(Context a, ArrayList<ShoppingProductModal> all_category_subcategory) {
        this.activity = a;
    ...
    public ReviewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemReviewItemBinding progressAdapterBinding = DataBindingUtil.inflate(LayoutInflater.from(activity)
                , R.layout.item_review_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.progressAdapterBinding.userName.setText("");
        holder.progressAdapterBinding.comments.setText("");

  /*      if (!all_category_subcategory.get(position).image.equals("")) {
            Picasso.get().load(all_category_subcategory.get(position).image).into(holder.progressAdapterBinding.ivPic);
        }*/
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ItemReviewItemBinding progressAdapterBinding;

        public MyViewHolder(ItemReviewItemBinding itemView) {
