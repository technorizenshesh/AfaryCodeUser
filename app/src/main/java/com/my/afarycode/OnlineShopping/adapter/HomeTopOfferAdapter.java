...
public class HomeTopOfferAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeTopOfferAdapter(Context context, ArrayList<HomeShopeProductModel> modelList) {
