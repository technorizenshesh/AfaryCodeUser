...
public class ShopProductListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ShopProductListAdapter(Context context, ArrayList<HomeShopeProductModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_shop_product, viewGroup, false);
